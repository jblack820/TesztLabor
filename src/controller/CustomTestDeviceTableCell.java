 ...
 */
public class CustomTestDeviceTableCell<S, T> extends TextFieldTableCell<S, T> {
            ...
            public TableCell<S, T> call(TableColumn<S, T> list) {
                ...
                final EventHandler<MouseEvent> enter = new EventHandler<MouseEvent>() {
                    ...
                    public void handle(MouseEvent event) {
                        ...
                        if (null != result.getText()) {
                            result.setStyle("-fx-background-color: #283955; -fx-alignment: CENTER-LEFT; -fx-text-fill: white");
                ...
                final EventHandler<MouseEvent> click = new EventHandler<MouseEvent>() {
                    ...
                    public void handle(MouseEvent event) {
                        ...
                        if (isTableCell(node)) {
                            tc = (TableCell) node;
                            DevicesPageController.handleEditRequest(tc.getText(), tc);
                        }
                    }
                };
